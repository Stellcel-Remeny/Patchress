...
(To add in an already compiled instance, follow compile-time steps from 1-4, but just use the 'RES' directory.)
...
4. Add in your other items (executables). The name must be in the **8.3** name format!
5. Compile the project. View [Instructions](docs/building.md#instructions)
