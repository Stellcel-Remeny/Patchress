// Application to set correct windows path for fix95cpu
// remeny
...
int main(int argc, char* argv[]) {
    ...
    status("  ENTER = Next");
    print_page("  Please enter the path to your Windows 95 installation.\n");
    cprintf("     ");
    ...
    wipe();
    if (win_path[0] == '\0') {
        print_page(" The path to your Windows 95 installation is empty.\n\n"
    ...
    // Execute patchmem
    title("Terminal Output - FIX95CPU.BAT");
    system("FIX95CPU.BAT");
