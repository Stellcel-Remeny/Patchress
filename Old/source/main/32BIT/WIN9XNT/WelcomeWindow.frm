...
Begin VB.Form WelcomeWindow 
   ...
   Begin VB.PictureBox Picture4 
      ...
      Height          =   615
      Left            =   -120
      Picture         =   "WelcomeWindow.frx":030A
      ScaleHeight     =   615
      ScaleWidth      =   10335
      TabIndex        =   3
      Top             =   6720
      ...
      Begin VB.PictureBox Picture7 
         ...
         Height          =   390
         Left            =   6480
         Picture         =   "WelcomeWindow.frx":12D9C
         ScaleHeight     =   390
         ScaleWidth      =   1155
         TabIndex        =   8
         Top             =   120
      ...
      Begin VB.PictureBox Picture6 
         ...
         Height          =   390
         Left            =   7680
         Picture         =   "WelcomeWindow.frx":1456E
         ScaleHeight     =   390
         ScaleWidth      =   1155
         TabIndex        =   6
         Top             =   120
      ...
      Begin VB.PictureBox Picture5 
         ...
         Height          =   390
         Left            =   9000
         Picture         =   "WelcomeWindow.frx":15D40
         ScaleHeight     =   390
         ScaleWidth      =   1155
         TabIndex        =   4
         Top             =   120
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   855
      Left            =   -120
      Picture         =   "WelcomeWindow.frx":17512
      ScaleHeight     =   855
      ScaleWidth      =   10335
      TabIndex        =   0
      Top             =   0
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   5895
      Left            =   -120
      Picture         =   "WelcomeWindow.frx":35104
      ScaleHeight     =   5895
      ScaleWidth      =   2535
      TabIndex        =   1
      Top             =   840
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   5895
      Left            =   2400
      Picture         =   "WelcomeWindow.frx":65F1E
      ScaleHeight     =   5895
      ScaleWidth      =   7815
      TabIndex        =   2
      Top             =   840
